...
class ArticleModel extends Model{
	...
	public function getColumn(){
            $sql = "select c.cateid,c.catename,c.orderid,c.catedesc,count(*) a_num from shop_category c join shop_article a on c.cateid = a.cateid group by a.cateid";
            $data = M('category')->query($sql);
            if(!empty($data)){
                    return $data;
            }
            return FALSE;
